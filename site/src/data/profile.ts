// Only owner-approved public profile content belongs here.
export const profile = {
  "name": "Luke Hallett",
  "positioning": "I’m Luke Hallett, a software engineer and technical leader with experience in enterprise applications, data platforms, and customer engineering. I help translate business needs into maintainable software and guide teams from technical design through delivery.",
  "about": [
    "My work has included hands-on development, solution architecture, engineering leadership, and customer problem-solving. I enjoy understanding how people work and building software that makes their jobs easier.",
    "This site brings together that experience and my own engineering projects, with explanations of the decisions behind the code and examples others can build on."
  ],
  "experience": [
    {
    ...
    {
      "employer": "Novell",
      "focus": "Solution architecture and software engineering",
      "description": "My work at Novell included solution architecture, technical leadership, application development, and support. I designed and developed software for licensing and digital delivery, contributed to architecture and coding standards, and coordinated development and testing with business teams."
    }
  ],
  "technicalFocus": [
